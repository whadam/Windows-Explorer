...
CFileTamDoc::CFileTamDoc() noexcept
{
...
void CFileTamDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CFileTamDoc::InitializeSearchContent()
{
...
void CFileTamDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
